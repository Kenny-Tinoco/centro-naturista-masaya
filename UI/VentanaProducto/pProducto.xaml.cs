...
namespace CentroNaturistaMasaya.UI.VentanaProducto
{
    public partial class pProducto : Page
    {
        ...
        private void salirDeAgregarProducto_Click(object sender, EventArgs e)
        {
            pVM.resetData();
            pVM.getAll();
        ...
        {
            agregarProducto aProducto = new agregarProducto(pVM, modificar);
            aProducto.salirDeAgregarProducto += new EventHandler(salirDeAgregarProducto_Click);
