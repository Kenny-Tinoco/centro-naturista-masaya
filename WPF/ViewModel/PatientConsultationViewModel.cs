...
{
    public class PatientConsultationViewModel : FormViewModel
    {
        ...
        public PatientConsultationViewModel(ILogic _logic, IMessenger _messenger, INavigationService modalNavigation)
        {
